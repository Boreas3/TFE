...
These results shows that for a degree $d=3$, the error with respect to the given points start to be acceptable. Going above this degree would be interested but, it will be expressed later that it is preferable to keep de polynomial degree as small as possible. Considering the low RPM operating points, the polynomial built perfectly fit the data starting from a degree $d=3$. The graphic representation of the two polynomials is given in the Figures \ref{fig:C7_polycomp_P_HRPM} and \ref{fig:C7_polycomp_P_LRPM}.
...
\begin{figure}[H]
    ...
    \end{subfigure}
    \caption{Polynomial regression ($d=3$) - $\Pi_{tt,c}(\dot{m}_{corr,c},N_c)$} \label{fig:C7_polycomp_P}
\end{figure}
...
The degree $d=3$ remains the best choice based on the results of the study. Respectively, the Figures \ref{fig:C7_polycomp_PN_HRPM} and \ref{fig:C7_polycomp_PN_LRPM} depict the polynomial for the high and low rotational speed operating points.
...
\begin{figure}[H]
    ...
    \end{subfigure}
    \caption{Polynomial regression ($d=3$) - $[\Pi_{tt,c}\cdot N_c](\dot{m}_{corr,c},N_c)$} \label{fig:C7_polycomp_PN}
\end{figure}
...
\toprule
\multicolumn{1}{c}{\multirow{2}{*}{\textit{\textbf{Relation}}}} & \multicolumn{1}{c}{\multirow{2}{*}{Degree}} & \multicolumn{2}{c|}{High RPM}                  & \multicolumn{2}{c}{Low RPM}                   \\
\multicolumn{1}{c}{}                                            & \multicolumn{1}{c}{}                        & \multicolumn{1}{c}{$\mathbf{F}$}          & $\chi^2$               & \multicolumn{1}{c}{$\mathbf{F}$}          & $\chi^2$               \\* \midrule
\endfirsthead
%
\endhead
%
...
\endlastfoot
%
$[\Pi_{tt,c}\cdot N_c](\dot{m}_{corr,c},N_c)$                   & \multicolumn{1}{c}{\textbf{3}}                                           & 0.021
                 & 0.962
                  & 1.22079E-05      & 1.000                 \\
...
Now that the degree of the polynomials has been set, the N-1 study can be performed.
This study consist in analyzing the difference of accuracy between the polynomial obtained using the complete data, and the polynomial generated based on the set of operating points where one have been removed. 

Thi
The polynomial based on the whole data will be labeled  $f_N(x,y)$, and the polynomial obtained where the $i^{th}$ operating point has been removed from the data 
...
\endlastfoot
%
\textbf{Degree}              & \textbf{F} & $\mathbf{\chi^2}$ & \textbf{F} & $\mathbf{\chi^2}$ \\
...
% \multicolumn{1}{c}{\textbf{Degree}} & multicolumn{1}{c}{$\mathbf{F}$}                       & multicolumn{1}{c}{$\mathbf{\chi^2}$}                       \\
% \textbf{1}      & 0.113                         & 0.678                              \\
% \multicolumn{1}{c}{\textbf{2}}      & 0.030                          & 0.915                               \\
% \multicolumn{1}{c}{\textbf{3}}      & 0.028                         & 0.919                              \\
% \multicolumn{1}{c}{\textbf{4}}      & 0.028                         & 0.920                               \\
% \multicolumn{1}{c}{\textbf{5}}      & 0.028                         & 0.921                               \\* \bottomrule
% \end{longtable}

% \begin{figure}[h]
%     \centering
%     \includegraphics[width=0.5\textwidth]{Comp_map/calc_231_map_trigo.png}
...
\endlastfoot
%
\multicolumn{1}{c}{\textbf{Degree}} & \multicolumn{1}{c}{$\mathbf{F}$}                       & \multicolumn{1}{c}{$\mathbf{\chi^2}$}                       & F                          & \multicolumn{1}{c}{$\mathbf{\chi^2}$}                   \\
\multicolumn{1}{c}{\textbf{1}}      & 0.055                          & 0.753                               & 0.108                   & 0.070                           \\
\multicolumn{1}{c}{\textbf{2}}      & 0.013                         & 0.943                               & 0.052                   & 0.550                           \\
\multicolumn{1}{c}{\textbf{3}}      & 0.002                         & 0.992                               & 0.018                  & 0.847                           \\
\multicolumn{1}{c}{\textbf{4}}      & 2.55E-04                         & 0.999                               & 0.004                   & 0.967                           \\
\multicolumn{1}{c}{\textbf{5}}      & 7.12E-05                         & 0.999                               & 0.001                   & 0.990                            \\
\multicolumn{1}{c}{\textbf{6}}      & 3.32E-05                         & 0.999                               & 6.98E-04                  & 0.993                           \\* \bottomrule
\end{longtable}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{/Turb_map/calc_356_map.png}
    \caption{$\eta_{is,t}(\Pi_{tt,t},N_t)$}
    \label{fig:C7_etaturb}
\end{figure}
Considering now the first relation, the value of the objective function $\mathbf{F}$ and of the square of the residual function $\chi^2$ shows that the fitting is nearly perfect for a polynomial of degree 4. 

\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{/Turb_map/calc_351_map.png}
    \caption{$\dot{m}_{corr,t}(\Pi_{tt,t},N_t)$}
    \label{fig:C7_mturb1}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{/Turb_map/calc_452_map.png}
...
\begin{longtable}[c]{@{}lll@{}}
\caption{Regression results - Turbine map (part 2)}
...
%
\multicolumn{1}{c}{\textbf{Degree}} & \multicolumn{1}{c}{$\mathbf{F}$}                          & \multicolumn{1}{c}{$\mathbf{\chi^2}$}                          \\
\multicolumn{1}{c}{\textbf{1}}      & 0.020                               & 0.974                                     \\
\multicolumn{1}{c}{\textbf{2}}      & 1.21E-03                            & 0.999                                     \\
\multicolumn{1}{c}{\textbf{3}}      & 1.79E-04                            & 1.000                                     \\
\multicolumn{1}{c}{\textbf{4}}      & 3.76E-05                            & 1.000                                     \\
\multicolumn{1}{c}{\textbf{5}}      & 1.5E-05                             & 1.000                                     \\
\multicolumn{1}{c}{\textbf{6}}      & 7.61E-06                            & 1.000                                     \\
\textbf{7}      & 7.79E-06                            & 1.000                                     \\* \bottomrule
\end{longtable}

With the relations $\dot{m}_{corr,t}\cdot\Pi_{tt,t}](\Pi_{tt,t}\cdot N_t,N_t)$ and $\eta_{is,t}(\Pi_{tt,t},N_t)$, the turbine is fully defined. The table \ref{tab:C7_turbmaprel} summarize the different obtained results. 
...
\endlastfoot
%
$\dot{m}_{corr,t}\cdot\Pi_{tt,t}](\Pi_{tt,t}\cdot N_t,N_t)$ & 3                       & 1.000 \\
$\eta_{is,t}(\Pi_{tt,t},N_t)$           & 6                       & 0.993        \\* \bottomrule
\end{longtable}