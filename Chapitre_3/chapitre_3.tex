...
% The second type of pump are the axial pumps which are, in opposition with the centrifugal pumps, designed to deliver low head for high flow rates. Such pumps are illustrated on Figure \ref{fig:C3_axial_pump}.
% \begin{figure}[h!]
%     \centering
