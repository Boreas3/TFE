...
These two relations allow to goes from one operating point to the other without modifying the value of the non-dimensional quantities. 
...
On the map, each doted line represent one isentropic efficiency contour. 
